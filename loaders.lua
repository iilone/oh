...
local omnihub = Instance.new("ScreenGui")
omnihub.Name = "OmniHub"
omnihub.Parent = game.CoreGui
omnihub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
